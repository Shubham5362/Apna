...
def run():
    # Ensure folders exist locally for maximum portability
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            if response is None or response.status >= 400:
                print(f"Failed to load page, response status: {response.status if response else 'None'}")
                sys.exit(1)
            ...
            print("Screenshot saved to verification/screenshots/verification.png")
